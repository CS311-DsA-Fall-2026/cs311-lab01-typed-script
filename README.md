# Lab 1: The Typed Script

Full assignment: `Lab_01_The_Typed_Script.md` (Blackboard / course repo).
...
2. `container.py` -- pushed to your repo
3. The Success Token -- pasted into the Blackboard textbox
